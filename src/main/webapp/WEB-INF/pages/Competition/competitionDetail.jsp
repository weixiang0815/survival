...
<div class="row mt-3 mb-3 p-3">
    <div class="col-12">
        中文活動名稱：${comp.mandarinName}
    </div>
    <div class="col-12">
        英文活動名稱：${comp.englishName}
    </div>
    <div class="col-3">
        開始日期：${comp.startDate}
    </div>
    ...
    <div class="col-12 align-text-start">
        <a href="${contextRoot}/competition/edit?id=${comp.id}"><button class="btn btn-primary">編輯</button></a>
        <a href="${contextRoot}/competition/delete?id=${comp.id}"><button class="btn btn-danger">刪除</button></a>
    </div>
</div>
</div>
