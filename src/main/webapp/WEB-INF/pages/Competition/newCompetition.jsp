							...
							<div class="input-group">
								<fieldset>
									...
									<form:select class="form-select" path="startTimespan">
										<form:option value="早上（6:00～12:00）" label="早上（6:00～12:00）"/>
										<form:option value="下午（12:00～18:00）" label="下午（12:00～18:00）"/>
										<form:option value="晚上（18:00～00:00）" label="晚上（18:00～00:00）"/>
										<form:option value="半夜（00:00～6:00）" label="半夜（00:00～6:00）"/>
									</form:select>
								...
								<fieldset>
									...
									<form:input class="form-control" type="number" path="budget" id="budget" placeholder="以新台幣計算" required="true"/>
									<form:label path="fee" class="form-label">報名費</form:label>
									<form:input class="form-control" type="number" path="fee" id="fee" placeholder="以新台幣計算" required="true"/>
									<form:label path="capacity" class="form-label">預計報名人數</form:label>
									<form:input class="form-control" type="number" path="capacity" id="capacity" placeholder="請填寫整數" required="true"/>
									<p>競賽模式</p>
									<form:radiobutton namm="singleOrCrew" class="form-check-input" path="singleOrCrew" id="single" value="S" label="單人戰" required="true"/>
									<form:radiobutton namm="singleOrCrew" class="form-check-input" path="singleOrCrew" id="crew" value="M" label="團體戰" required="true"/>
								</fieldset>
								<fieldset>
									<legend>詳細資料</legend>
								</fieldset>
