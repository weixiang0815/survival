...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-secondary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
            <h1 class="mb-0 text-primary text-uppercase"><i class="fa-solid fa-person-rifle"></i>&nbsp;Survival</h1>
        </a>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="price.html" class="dropdown-item">價位</a>
                        <a href="team.html" class="dropdown-item">設計師</a>
                        <a href="open.html" class="dropdown-item">服務時段</a>
                        <a href="testimonial.html" class="dropdown-item">顧客評價</a>
                        <a href="404.html" class="dropdown-item">404</a>
                    </div>
                </div>
                <a href="contact.html" class="nav-item nav-link">聯絡我們</a>
            </div>
            <a href="" class="btn btn-primary rounded-0 py-2 px-lg-4 d-none d-lg-block">立即預約<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="${contextRoot}/img/carousel-1.jpg" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="${contextRoot}/img/carousel-2.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center text-start">
                        <div class="mx-sm-5 px-5" style="max-width: 900px;">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-0">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="h-100">
                        <img class="img-fluid h-100" src="${contextRoot}/img/open.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="bg-secondary h-100 d-flex flex-column justify-content-center p-5">
    ...
    <script src="${contextRoot}/lib/wow/wow.min.js"></script>
    ...
    <!-- Template Javascript -->
    <script src="${contextRoot}/js/front/main.js"></script>
</body>
