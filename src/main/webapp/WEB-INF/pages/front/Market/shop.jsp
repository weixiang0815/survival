							...
							<div class="catagories-menu">
								<ul id="menu-content2" class="menu-content collapse show">
										...
										<ul class="collapse" id="submenu-guns">
											<form action="" id="searchFormData">
												...
												<label class="nav-link">分類</label><br> <label
													...
													class="clazz" name="check_class" value="手槍"
													id="check_clazz">手槍</label><br> <label
													style="color: #ffffff;"><input type="checkbox"
													class="clazz" name="check_class" value="步槍"
									...
									<li data-toggle="collapse" data-target="#accessories"
										class="nav-item"><a href="#submenu-accessories"
										data-bs-toggle="collapse" data-bs-parent="#sidebarMenu"
										class="nav-link" style="color: #ffffff;">配件</a>
								...
								<li data-toggle="collapse" data-target="#clothing"
									class="nav-item"><a href="#submenu-clothing"
									data-bs-toggle="collapse" data-bs-parent="#sidebarMenu"
									class="nav-link" style="color: #ffffff;">服飾</a>
						...
						<div class="text-center mx-auto mb-5 wow fadeInUp">
							<div>
								<div id="photos__container">
									<div class="photo">
										<img src="${contextRoot}/img/product-img/product-2.jpg"
											alt="photo">
									</div>


									<c:forEach items="${list}" var="show_Product"
										varStatus="Status">
										<div class="photo">
											<a
