...
<form action="${contextRoot}/Market/productIn2" method="get">
  <table><tr>
  <td> <input type="checkbox" id="vehicle1" name="product_class" value="手槍">
  <label for="vehicle1"> 手槍</label></td>

  <td><input type="checkbox" id="vehicle2" name="product_class" value="步槍">
  <label for="vehicle2"> 步槍</label></td>

  <td><input type="checkbox" id="vehicle3" name="product_class" value="衝鋒槍">
  <label for="vehicle3"> 衝鋒槍</label></td>
  
  <td><input type="checkbox" id="vehicle4" name="product_class" value="狙擊槍">
  <label for="vehicle3"> 狙擊槍</label></td>
  
  <td><input type="checkbox" id="vehicle5" name="product_class" value="霰彈槍">
  <label for="vehicle3"> 霰彈槍</label></td>
