		...
		<nav class="navbar navbar-expand-lg bg-secondary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn"
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<div class="navbar-nav ms-auto p-4 p-lg-0">
					<a href="${contextRoot}/" class="nav-item nav-link active">首頁</a> <a href="${contextRoot}/about"
						class="nav-item nav-link">關於</a>
					<div class="nav-item dropdown">
						<a href="" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">服務</a>
						<div class="dropdown-menu m-0">
							...
							<a href="${contextRoot}/front/place/index" class="dropdown-item">場地</a> <a
								href="${contextRoot}/front/Market/index" class="dropdown-item">戰略商城</a> <a
